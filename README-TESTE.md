...
```http
POST http://localhost:3333/api/whatsapp/start
Content-Type: application/json

{
    "phoneId": "SEUTELEFONEAQUI@c.us"
}
```

E em seguida, fique pedindo o `GET /api/whatsapp/status/SEUTELEFONEAQUI@c.us` até a resposta cair pra `QR_CODE_READY`.
